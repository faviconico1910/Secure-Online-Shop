...
function findWasmBinary() {
    return locateFile('oqs_wrapper.wasm');
}
...
var _keypair = Module['_keypair'] = makeInvalidEarlyAccess('_keypair');
...
function assignWasmExports(wasmExports) {
  ...
  Module['_keypair'] = _keypair = createExportWrapper('keypair', 2);
  Module['_sign'] = _sign = createExportWrapper('sign', 5);
  Module['_verify'] = _verify = createExportWrapper('verify', 5);
